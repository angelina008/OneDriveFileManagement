...
namespace OneDriveFileManagement.CLI.Commands
{
    class HelpCommand : ICommand
    {
        ...
        public async Task ExecuteAsync(string[] args)
        {
            ...
            Console.WriteLine("default -> Uploads file in specific oneDrive folder, downloads the same file in specific loacl folder, and compares the 2 files, all with predefined values.");
        }
    }
}
